                ...
                <div class="product-content-right ">
                    <div class="woocommerce ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="actions" colspan="6">
                                            ...
                                            <input type="submit" value="Cập nhật giá" name="update_cart" class="button">
                                            <!--<input type="submit" value="Đặt hàng" name="check_out" class="button"> -->
                        ...
                        <div class="cart-collaterals ">
                                ...
                                <ul class="products ">
                                    <li class="product ">
                                        <a href="single-product.php ">
                                            <img width="325" height="325" alt="T_4_front " class="attachment-shop_catalog wp-post-image " src="admin/product/uploads/shipber1.png ">
                                            <h3>Gợi ý phí giao hàng </h3>   <!--chưa được-->
                                            <span class="price "><span class="amount">20.000VND</span></span>
                                        </a>

                                        <a class="add_to_cart_button " data-quantity="1 " data-product_sku=" " data-product_id="22 " rel="nofollow " href="#">Chọn</a>
                                    </li>

                                    <li class="product ">
                                        <a href="single-product.php ">
                                            <img width="325" height="325" alt="T_4_front " class="attachment-shop_catalog wp-post-image " src="admin/product/uploads/shipber1.png ">
                                            <h3>Gợi ý phí giao hàng</h3>
                                            <span class="price "><span class="amount">20.000VND</span></span>
                                        </a>
                            ...
                            <form method="post" action="" class="shipping_calculator"><!--Chưa thực hiện được-->
                                <h2>
