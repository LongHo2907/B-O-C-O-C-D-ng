    ...
    <div class="container">
        ...
        ?>
            <div class="alert alert-primary" role="alert">
                <span style="font-Size:1.5em;"><?php echo $_SESSION['success'] ?></span>
                <a href="orders.php">Xem đơn hàng của bạn</a><br>
                <a href="index.php">Tiếp tục mua Hàng </a><br>
            </div>
        <?php } ?>
        <div class="row">
            <div class="col-md-4">
        ...
        -->
                                        <p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                            <label class="" for="billing_first_name">Họ tên người nhận<abbr title="required" class="required">*</abbr>
                                            </label>
                                            <input type="text" value="<?php echo $user['full_name'] ?>" placeholder="" id="billing_first_name" name="shipping_full_name" class="input-text" title="Vui lòng nhập họ tên người nhận" required>
                                        </p>
                                        ...
                                        <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                            ...
                                            <input type="text" value="<?php echo $user['address'].', '.$user['city'] ?>" placeholder="Quận,huyện,.. " id="billing_address_1" name="shipping_address" class="input-text " title="Vui lòng nhập địa chỉ nhận hàng" required>
                                        </p>
                                        ...
                                        <p id="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                                            <label class="" for="billing_phone">Số điện thoại người nhận<abbr title="required" class="required">*</abbr>
                                            </label>
                                            <input type="text" value="<?php echo $user['phone'] ?>" placeholder="" id="billing_phone" name="shipping_phone" class="input-text " title="Vui lòng nhập số điện thoại người nhận" required>
                                        </p>
                                        <div class="clear"></div>
