...
require_once('D:\XAMPP\htdocs\shoplaptop-master\db.php');
...
class Brand extends DB implements Ibrand
{
    ...
    {
        $stm = $this->db->prepare("SELECT b.id, b.name FROM brand b INNER JOIN product p ON p.brand_id=b.id WHERE brand_id= $id");
