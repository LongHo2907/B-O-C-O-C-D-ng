...
if (isset($_POST['submit'])) {
    ...
    $_SESSION['success'] = "Sửa thành công " . 'sản phẩm';
    ...
    <div class="container-fluid">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-5 col-lg-5">
                ...
                <!-- 3 category -->
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Thể loại</label>
                    <div class="col-sm-10">
                        <select name="cate_id">
                            <option value="0">Thể loại</option>
                            <?php foreach ($listcate as $cate) {
                            ?>
                                <option <?php if ($cate['id'] == $catesOfProduct['id']) echo 'selected'; ?> value="<?php echo $cate['id'];  ?>"><?php echo $cate['name'] ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" value="<?php echo $obj['quantity_product'] ?>" name="quantity" required>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-5 col-lg-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="<?php echo $obj['connect'] ?>" name="connect" placeholder="Wifi, bluetooth " required>
                    </div>
                </div>
                <!-- <div class="form-group row">
