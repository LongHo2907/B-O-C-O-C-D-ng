...
<body>
    ...
    <!-- <div class="container">
        ...
        <p><strong>Nhấp vào tiêu đề để sắp xếp bảng.</strong></p>
        <p>Lần đầu tiên bạn nhấp chuột, hướng sắp xếp tăng dần (A đến Z).</p>
        <p>Nhấp lại và hướng sắp xếp sẽ giảm dần (Z đến A):</p>
    </div> -->
