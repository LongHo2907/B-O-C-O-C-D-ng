...
if (isset($_GET['product_id'])) {
    ...
    $brand = new brand();
    $brand = $brand ->getBrandProduct($productSingle['id']);
} else {
    //header('Location:http://localhost/shoplaptop-master');
}
                ...
                <div class="product-content-right">
                    <div class="product-breadcroumb">
                        ...
                        <?php //foreach ($cates as $category) { ?>
                                <a href="productByCategory.php?cate=<?php echo $cates['id']; ?>"><?php echo $cates['name']; ?></a> 
                        <?php //} ?>
                                            ...
                                            <table class="table table-striped table-inverse table-responsive">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php if ($productSingle['quantity_product'] > 0) echo 'Còn hàng';
